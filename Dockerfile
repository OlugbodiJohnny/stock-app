...
RUN echo "web: java $JAVA_OPTS -jar stock-app-2-0.0.1-SNAPSHOT.jar --spring.config.location=application-prod.properties" > Procfile
...
#
#ENV SPRING_JPA_HIBERNATE_SHOW_SQL ${SPRING_JPA_HIBERNATE_SHOW_SQL}
#
#ENV SPRING_ADMIN_EMAIL ${SPRING_ADMIN_EMAIL}
#
#ENV SPRING_ADMIN_PASSWORD ${SPRING_ADMIN_PASSWORD}
#
...
#
#ENV SPRING_MAIL_SMTP_AUTH ${SPRING_MAIL_SMTP_AUTH}
#
#ENV SPRING_MAIL_SMTP_STARTTLS ${SPRING_MAIL_SMTP_STARTTLS}
#
#ENV SPRING_MAIL_SMTP_SLL_ENABLE ${SPRING_MAIL_SMTP_SLL_ENABLE}
#
...
#
#ENV POLYGON_BASE_URL ${POLYGON_BASE_URL}
#
